	...
	i.VERSION = "3.3.5", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
		...
		if (this.hasContent() && this.enabled) {
			...
			if (h) {
				...
				r = "bottom" == r && p.bottom + d > u.bottom ? "top" : "top" == r && p.top - d < u.top ? "bottom" : "right" == r && p.right + c > u.width ? "left" : "left" == r && p.left - c < u.left ? "right" : r, s.removeClass(f).addClass(r)
			}
		...
		if (/right|left/.test(t)) {
			...
			var h = e.left - s,
				p = e.left + s + i;
			h < a.left ? n.left = a.left - h : p > a.right && (n.left = a.left + a.width - p)
		}
		return n
